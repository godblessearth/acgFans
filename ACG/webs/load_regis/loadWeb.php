...
<div id="container">
	<div id="pictures"><img class="picImg" src="../../pictures/1.5.jpg" width="100%" height="100%"></div>
	<div id="load">
		<div class="loadLogo"><h1>登陆</h1></div>
		<hr/>
		<form action="loadmatch.php" method="post" autocomplete="on">
		<div class="loadInput"><input type="text" placeholder=" 请输入帐号"  name="fname"/></div>
		<div class="loadInput"><input type="password" placeholder=" 您的密码" name="passwd"/></div>
		<div class="frogetPass"><a href="loadWeb.html">忘记密码？></a></div>
		<div class="btnLoad"><input class="loading" type="submit" value="登陆">
		</form>
			<a class="reg" href="registerWeb.php">注册</a>
		</div>
	</div>
</div>
