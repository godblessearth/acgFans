...
//浮动信息窗口
	...
	$(".leftAni").mouseleave(function(){
		$(".titleLeftAni").animate({top:'330px'});
  });
	$(".leftAni").mouseenter(function(){
		$(".titleLeftAni").animate({top:'290px'});
  }); 
	$(".leftAni").mouseenter(function(){
	...
	$(".leftCom").mouseleave(function(){
		$(".titleLeftCom").animate({top:'330px'});
  });
	$(".leftCom").mouseenter(function(){
		$(".titleLeftCom").animate({top:'290px'});
  }); 
	$(".leftCom").mouseenter(function(){
		$(".titleLeftCom").css({"display":"block","background":"#444","color":"#fff"});
  }); 
 //图片切换
	var img=new Array("1.1.jpg","1.2.jpg","1.3.jpg","1.4.jpg","1.5.jpg","1.6.jpg","1.7.jpg","1.8.jpg");//创建图片地址数组
